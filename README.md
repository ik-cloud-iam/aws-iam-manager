...
1. Execute ```serverless deploy``` and wait for results. This will deploy a function allowing
to notify [Amazon Simple Notification Service](https://aws.amazon.com/sns/). The function will live in US East (N. Virginia).
